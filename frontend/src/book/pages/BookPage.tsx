...
export default function BookPage() {
  ...
  const {books, error, count, loading} = useAppSelector((state: RootState) => state.books);
                    ...
                    >
                      ...
                      <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row justify-center sm:px-20">
                        <button
                          ...
                          onClick={() => dispatch(fetchBooks({page: 1, limit: ITEMS_PER_PAGE}))}
                        >
                          Entendido
                        </button>
                      </div>
