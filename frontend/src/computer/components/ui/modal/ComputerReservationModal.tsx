type ComputerReservationModalProps = {
  recurseId?: number;
  show: boolean;
  onClose: () => void;
...
const ComputerReservationModal = ({recurseId, show, onClose, onSubmit, register, errors, formValues, isValid}: ComputerReservationModalProps) => {
              ...
              <div className="flex flex-col items-center justify-center gap-3">
                ...
                <div className="text-center mt-0">
                  ...
                  >
                    ...
                    <input type="hidden" {...register("resource_type")} value="computer"/>
...
export default ComputerReservationModal;
